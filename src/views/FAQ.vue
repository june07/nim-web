                                ...
                                <v-expansion-panel-text>
                                    <v-card rounded="xl">
                                        ...
                                        <v-card-text class="ml-8">
                                            <ul>
                                                <li><a href="https://june07.com/tag/nim/" target="_blank" rel="noopener">Blog Articles</a></li>
                                                <li><a href="https://github.com/june07/nimv3/issues" target="_blank" rel="noopener">GitHub Issues</a></li>
                                                <li><a href="mailto:support@june07.com?subject=NiM Support" target="_blank" rel="noopener">Email Support</a></li>
                                            </ul>
                                        </v-card-text>
                                    </v-card>
                                </v-expansion-panel-text>
